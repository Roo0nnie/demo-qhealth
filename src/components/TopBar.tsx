...
const TopBar: React.FC<TopBarProps> = ({ isMeasuring = false, durationSeconds = 60, onRefresh, isRefreshing = false }) => {
	...
	return (
		<div className="fixed top-0 left-0 right-0 w-full flex justify-between items-center h-[60px] z-[2] shadow-md bg-[#271ebf] transition-all duration-300 px-4 md:relative md:pl-[100px] md:pr-6">
